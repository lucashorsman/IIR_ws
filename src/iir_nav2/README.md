...
```shell
ros2 launch iir_nav2 cloned_multi_tb3_simulation_launch.py robots:="robot1={x: 1.0, y: 1.0, yaw: 1.5707}; robot2={x: 1.0, y: 1.0, yaw: 1.5707}"
```
...
```shell
ros2 launch iir_nav2 unique_multi_tb3_simulation_launch.py
```
